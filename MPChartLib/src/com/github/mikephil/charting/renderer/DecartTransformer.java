 ...
 */
public class DecartTransformer {
     ...
     * @return
     */
    public float[] generateTransformedValuesDecart(ArrayList<? extends DecartEntry> entries,
            float phaseY) {
        ...
        for (int j = 0; j < valuePoints.length; j += 2) {
            ...
            DecartEntry e = entries.get(j / 2);

            if (e != null) {
                valuePoints[j] = e.getXVal();
                valuePoints[j + 1] = e.getYVal() * phaseY;
            }
        }
