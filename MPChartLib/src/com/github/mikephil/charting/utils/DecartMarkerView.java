 ...
 */
public abstract class DecartMarkerView extends RelativeLayout {
     ...
     */
    public DecartMarkerView(Context context, int layoutResource) {
        super(context);
     ...
     */
    public abstract void refreshContent(DecartEntry e);
